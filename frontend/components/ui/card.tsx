...
const CardHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    // Milestone 7C: p-6 (24px) on every breakpoint ate too much vertical
    // space on phones across a stack of cards; tightened for small screens
    // only, unchanged (p-6) from sm/tablet up.
